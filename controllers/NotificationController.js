...
const getNotificationsFromStaff = async (req, res) => {
    try {
        const userId = req.user._id;
...
const markAllNotificationsAsReadFromStaff = async (req, res) => {
    try {
        const userId = req.user._id;
...
const markNotificationAsReadFromStaff = async (req, res) => {
    try {
        const userId = req.user._id;
        const user = await StaffModel.findById(userId);
        if (!user) {
